...
def run_training_script():
    try:
        ...
        training_script = os.path.join(
            ...
            '../sentiment/model/time/positive/train_news_scorer.py'
        )
...
def backup_previous_model():
    """이전 모델 백업"""
    try:
        model_path = "/content/drive/MyDrive/news_scorer_model.pkl"  # 실제 모델 경로로 수정
...
def validate_new_model():
    ...
    try:
        ...
        if file_size < 1024 * 1024:  # 1MB 미만이면 의심
